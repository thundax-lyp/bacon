...
public class OrderCommandFacadeRemoteImpl implements OrderCommandFacade {
    ...
    public void markPaid(
        ...
        restClient
                .post()
                .uri(
                        "/providers/orders/mark-paid?tenantId={tenantId}&orderNo={orderNo}&paymentNo={paymentNo}"
    ...
    public void markPaymentFailed(
        ...
        restClient
                .post()
                .uri(
                        "/providers/orders/mark-payment-failed?tenantId={tenantId}&orderNo={orderNo}&paymentNo={paymentNo}"
    ...
    public void closeExpiredOrder(Long tenantId, String orderNo, String reason) {
        ...
        restClient
                .post()
                .uri(
                        "/providers/orders/close-expired?tenantId={tenantId}&orderNo={orderNo}&reason={reason}",
                        tenantId,
                        orderNo,
                        reason)
                .retrieve()
