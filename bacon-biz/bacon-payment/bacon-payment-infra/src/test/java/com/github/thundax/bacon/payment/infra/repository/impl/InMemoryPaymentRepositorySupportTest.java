...
class InMemoryPaymentRepositorySupportTest {
    ...
    void shouldPersistPaymentOrderAndSupportOrderScopedIdempotentLookup() {
        ...
        assertEquals(
                "PAY-10001",
                repository
                        .findOrderByPaymentNo(1001L, "PAY-10001")
                        .orElseThrow()
                        .getPaymentNo()
                        .value());
        assertEquals(
                "ORD-10001",
                repository
                        .findOrderByOrderNo(1001L, "ORD-10001")
                        .orElseThrow()
                        .getOrderNo()
                        .value());
    }
    ...
    void shouldKeepLatestCallbackAndAuditLogOrdering() {
        ...
        repository.saveCallbackRecord(new PaymentCallbackRecord(
                null,
                TenantId.of(1001L),
        ...
        repository.saveAuditLog(new PaymentAuditLog(
                null,
                TenantId.of(1001L),
                PaymentNo.of("PAY-10002"),
        ...
        PaymentCallbackRecord latest =
                repository.findLatestCallbackByPaymentNo(1001L, "PAY-10002").orElseThrow();
    ...
    void shouldFindCallbackByChannelTransactionNo() {
        ...
        PaymentCallbackRecord callbackRecord = repository
                .findCallbackByChannelTransactionNo(1001L, "MOCK", "TXN-30001")
                .orElseThrow();
