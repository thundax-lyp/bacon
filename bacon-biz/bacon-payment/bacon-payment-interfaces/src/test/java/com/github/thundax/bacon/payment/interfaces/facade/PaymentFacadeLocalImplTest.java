...
class PaymentFacadeLocalImplTest {
    ...
    void commandFacadeShouldDelegateCreatePaymentWithFacadeRequest() {
        ...
        when(createService.createPayment(
                        request.getOrderNo(),
                        request.getUserId(),
                        request.getAmount(),
    ...
    void commandFacadeShouldRequireTenantBeforeClosePayment() {
        ...
        assertThrows(
                ...
                () -> facade.closePayment(new PaymentCloseFacadeRequest("PAY-10001", "SYSTEM_CANCELLED")));
    ...
    void commandFacadeShouldDelegateClosePaymentWithFacadeRequest() {
        ...
        verify(closeService).closePayment(request.getPaymentNo(), request.getReason());
    }
    ...
    void readFacadeShouldDelegateGetByPaymentNoWithFacadeRequest() {
        ...
        when(queryService.getByPaymentNo(request.getPaymentNo()))
        ...
        assertEquals("ORD-10001", response.getOrderNo());
        verify(queryService).getByPaymentNo(request.getPaymentNo());
    }
    ...
    void readFacadeShouldDelegateGetByOrderNoWithFacadeRequest() {
        ...
        when(queryService.getByOrderNo(request.getOrderNo()))
                .thenReturn(new PaymentDetailDTO(
                        "PAY-10001",
                        "ORD-10001",
                        2001L,
        ...
        assertEquals("PAY-10001", response.getPaymentNo());
        verify(queryService).getByOrderNo(request.getOrderNo());
    }
}
