...
public class StoredObjectRepositoryImpl implements StoredObjectRepository {
    ...
    public List<StoredObject> pageObjects(
        ...
        LambdaQueryWrapper<StoredObjectDO> listWrapper = buildQueryWrapper(
                        tenantId, storageType, objectStatus, referenceStatus, originalFilename, objectKey)
    ...
    public long countObjects(
        ...
        LambdaQueryWrapper<StoredObjectDO> countWrapper =
                buildQueryWrapper(tenantId, storageType, objectStatus, referenceStatus, originalFilename, objectKey);
    ...
    private StoredObject toDomain(StoredObjectDO dataObject) {
        return new StoredObject(
                ...
                StorageType.from(dataObject.getStorageType()),
