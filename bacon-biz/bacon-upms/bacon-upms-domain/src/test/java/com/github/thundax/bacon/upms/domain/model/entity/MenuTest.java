...
class MenuTest {
    ...
    void shouldAddAndRemoveChild() {
        Menu parent = Menu.create(MenuId.of(101L), "CATALOG", "Catalog", null, "/catalog", "CatalogPage", "catalog", null);
        Menu child = Menu.create(MenuId.of(102L), "MENU", "Child", parent.getId(), "/catalog/child", "ChildPage", "child", null);
