...
public class DepartmentReadFacadeRemoteImpl implements DepartmentReadFacade {
    ...
    public DepartmentDTO getDepartmentById(@NonNull TenantId tenantId, @NonNull DepartmentId departmentId) {
        ...
        return restClient.get()
                .uri("/providers/upms/departments/{departmentId}?tenantId={tenantId}", departmentId.value(), tenantId.value())
                .retrieve()
    ...
    public DepartmentDTO getDepartmentByCode(@NonNull TenantId tenantId, String departmentCode) {
        return restClient.get()
                .uri("/providers/upms/departments/code/{departmentCode}?tenantId={tenantId}", departmentCode, tenantId.value())
                .retrieve()
                .body(DepartmentDTO.class);
    }
    ...
    public List<DepartmentDTO> listDepartmentsByIds(@NonNull TenantId tenantId, @NonNull Set<DepartmentId> departmentIds) {
        ...
        return restClient.get()
                .uri(uriBuilder -> uriBuilder.path("/providers/upms/departments")
                        ...
                        .queryParam("departmentIds", departmentIds.stream().map(DepartmentId::value).toArray())
                        .build())
                .retrieve()
                .body(LIST_TYPE);
    }
