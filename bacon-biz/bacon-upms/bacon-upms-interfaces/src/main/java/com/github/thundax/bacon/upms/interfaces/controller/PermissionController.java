...
import com.github.thundax.bacon.upms.interfaces.response.PermissionCodeSetResponse;
...
public class PermissionController {
    ...
    public PermissionCodeSetResponse findPermissionCodesByUserId(
            @PathVariable("userId") @Positive(message = "userId must be greater than 0") Long userId) {
        return new PermissionCodeSetResponse(permissionQueryService.findPermissionCodesByUserId(UserIdCodec.toDomain(userId)));
    }
