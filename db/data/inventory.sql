...
INSERT INTO `bacon_inventory_inventory` (
    ...
    (5000001, 1001, 3001001, 1, 200, 30, 170, 'ACTIVE', 1, 2000001, '2026-03-26 10:00:00.000', 2000001, '2026-03-26 10:00:00.000'),
    (5000002, 1001, 3001002, 1, 120, 0, 120, 'ACTIVE', 1, 2000001, '2026-03-26 10:00:30.000', 2000001, '2026-03-26 10:00:30.000')
...
INSERT INTO `bacon_inventory_reservation` (
    `id`, `tenant_id`, `reservation_no`, `order_no`, `reservation_status`, `warehouse_id`,
    `failure_reason`, `release_reason`, `created_at`, `released_at`, `deducted_at`
) VALUES
    (5100001, 1001, 'RSV-20260326-0001', 'ORDER-INV-20260326-0001', 'RESERVED', 1,
        NULL, NULL, '2026-03-26 10:05:00.000', NULL, NULL),
    (5100002, 1001, 'RSV-20260326-0002', 'ORDER-INV-20260326-0002', 'FAILED', 1,
...
INSERT INTO `bacon_inventory_ledger` (
    `id`, `tenant_id`, `order_no`, `reservation_no`, `sku_id`, `warehouse_id`,
    `ledger_type`, `quantity`, `occurred_at`
) VALUES
    (5300001, 1001, 'ORDER-INV-20260326-0001', 'RSV-20260326-0001', 3001001, 1, 'RESERVE', 20, '2026-03-26 10:05:10.000'),
    (5300002, 1001, 'ORDER-INV-20260326-0001', 'RSV-20260326-0001', 3001001, 1, 'RELEASE', 5, '2026-03-26 10:05:40.000')
ON DUPLICATE KEY UPDATE
...
INSERT INTO `bacon_inventory_audit_outbox` (
    ...
    (5500001, 1001, 'ORDER-INV-20260326-0003', 'RSV-20260326-0003',
    ...
    (5500002, 1001, 'ORDER-INV-20260326-0004', 'RSV-20260326-0004',
...
INSERT INTO `bacon_inventory_audit_dead_letter` (
    `id`, `outbox_id`, `tenant_id`, `order_no`, `reservation_no`,
    `action_type`, `operator_type`, `operator_id`, `occurred_at`,
    `retry_count`, `error_message`, `dead_reason`, `dead_at`
) VALUES
    (5600001, 5500002, 1001, 'ORDER-INV-20260326-0004', 'RSV-20260326-0004',
        'DEDUCT', 'SYSTEM', 0, '2026-03-26 10:08:00.000',
