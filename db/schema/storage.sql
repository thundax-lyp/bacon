CREATE TABLE IF NOT EXISTS `bacon_storage_object` (
    `id` BIGINT NOT NULL COMMENT '存储对象业务主键',
    `stored_object_no` VARCHAR(64) NOT NULL COMMENT '存储对象外部编号',
    `tenant_id` BIGINT DEFAULT NULL COMMENT '所属租户业务键',
...
CREATE TABLE IF NOT EXISTS `bacon_storage_object_reference` (
    `object_id` BIGINT NOT NULL COMMENT '存储对象业务主键',
...
CREATE TABLE IF NOT EXISTS `bacon_storage_audit_log` (
    ...
    `tenant_id` BIGINT DEFAULT NULL COMMENT '所属租户业务键',
    `object_id` BIGINT DEFAULT NULL COMMENT '存储对象业务主键',
