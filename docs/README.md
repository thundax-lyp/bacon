...
3. 如果任务涉及数据库设计，再加载 [`DATABASE-REQUIREMENTS.md`](./DATABASE-REQUIREMENTS.md)
4. 如果任务涉及某业务域数据库，再加载对应 `*-DATABASE-DESIGN.md`
5. 如果任务涉及写文档规范，再加载 [`DOCUMENT-REQUIREMENTS.md`](./DOCUMENT-REQUIREMENTS.md)
...
- [`DOCUMENT-REQUIREMENTS.md`](./DOCUMENT-REQUIREMENTS.md)
...
- [`AUTH-DATABASE-DESIGN.md`](./AUTH-DATABASE-DESIGN.md)
  ...
  - 前置：先加载 [`DATABASE-REQUIREMENTS.md`](./DATABASE-REQUIREMENTS.md)。
...
3. [`DATABASE-REQUIREMENTS.md`](./DATABASE-REQUIREMENTS.md)
...
1. [`DOCUMENT-REQUIREMENTS.md`](./DOCUMENT-REQUIREMENTS.md)
2. 目标业务域 `*-REQUIREMENTS.md` 或 `*-DATABASE-DESIGN.md`
3. 若涉及工程约束，再补 [`ARCHITECTURE.md`](./ARCHITECTURE.md) 或 [`DATABASE-REQUIREMENTS.md`](./DATABASE-REQUIREMENTS.md)
...
1. [`ARCHITECTURE.md`](./ARCHITECTURE.md)
2. 对应业务域 `*-REQUIREMENTS.md`
3. 如果改动涉及数据库，再加载 [`DATABASE-REQUIREMENTS.md`](./DATABASE-REQUIREMENTS.md) 与对应 `*-DATABASE-DESIGN.md`
...
- 工程级规则优先级高于业务域文档：
  ...
  - 数据库规则以 [`DATABASE-REQUIREMENTS.md`](./DATABASE-REQUIREMENTS.md) 为准
  - 文档写作规则以 [`DOCUMENT-REQUIREMENTS.md`](./DOCUMENT-REQUIREMENTS.md) 为准
